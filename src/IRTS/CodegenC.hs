...
doOp v LAllocate [x] = v ++ "BUFFER_ALLOCATE(vm, " ++ creg x ++ ")"
doOp v LPeek [x, y] = v ++ "BUFFER_PEEK(vm, " ++ creg x ++ ", " ++ creg y ++ ")"
doOp v LAppend [x, y, z] = v ++ "BUFFER_APPEND(vm, " ++ creg x ++ ", " ++ creg y ++ ", " ++ creg z ++ ")"
